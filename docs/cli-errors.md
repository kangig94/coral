...
| `startup_bundle_unresolvable`         | Backend startup could not resolve the running bundle directory required to publish and follow the active-store selection authority                                                                                                                                     |
