...
| `provider_host_inventory_unavailable`         | At least one captured coordinator-local or provider-proxy host owner failed to return a valid complete inventory. No partial rows or mutation are returned                                                                                                                                                                                                                                                                                                    |
| `provider_host_not_found`                     | No live or retained-blocked provider host matches the exact reference or canonical work-directory selector                                                                                                                                                                                                                                                                                                                                                    |
| `provider_host_ambiguous`                     | A canonical work directory matches more than one host. Retry with one exact `HOST_REF` from `backend provider-host list`                                                                                                                                                                                                                                                                                                                                      |
| `provider_host_identity_integrity`            | An exact host identity matched multiple records or owners, so Coral refused rather than choosing one                                                                                                                                                                                                                                                                                                                                                           |
| `provider_host_stale`                         | The selected host changed or disappeared before its owning process could revalidate the exact reference; Coral did not retarget the operation                                                                                                                                                                                                                                                                                                                  |
