...
**Interactions.** `docs/todo/shutdown-remainder-has-no-reader.md` (the remaining Track B work decides how a
live held drain appears through health, which is where an offer would have to reappear if one is ever justified).
