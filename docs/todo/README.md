...
| [`provider-operation-raw-evidence-quarantine.md`](./provider-operation-raw-evidence-quarantine.md) | Startup can retain an exact unreadable row and refuse recovery, but there is no operator-authorized, byte-preserving exit when its processes cannot be proved absent. The missing capability must CAS the active revision into raw quarantine atomically and audit that it may abandon unobservable provider work. |
...
| [`coordinator-process-disposition.md`](./coordinator-process-disposition.md)     | Recovery commits its disposition before process-local cleanup. External process absence must become a required completion obligation before terminal and claim-release facts, while cleanup returns to releasing only in-memory ownership.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
