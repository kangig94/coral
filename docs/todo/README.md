...
|                                                                                |                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`unit-suite-concurrency-and-real-time-tests.md`](./unit-suite-concurrency-and-real-time-tests.md) | **Half closed: the store opens are out of the concurrent tier.** Two test-helper defaults, not a missing abstraction, were why unit tests opened real stores; both now require an explicit path and an invariant requires the literal `':memory:'` at the store doors. Seventeen tests that genuinely need a file moved to single-fork integration. The real-time half is measured and small. |
