...
|                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`partial-redemption-guardian-ownership.md`](./partial-redemption-guardian-ownership.md) | **Found auditing `overload-tolerance-floor` after it shipped.** A downstream role's `teardown-latched` refusal during redemption discards the guardian session that just answered it instead of adopting it, so the coordinator falls back to the same independent-absence wait used for genuinely ambiguous refusals. Safe — nothing is destroyed on unproven evidence — but slower than the fast path the plan specifies, and the session is wasted for no reason. |
...
| [`durable-cli-signal-authority.md`](./durable-cli-signal-authority.md)           | **The remaining signal behaviours hold the evidence and never read it.** A durable CLI child's pid is signalled while `durable_cli_process.v1` carries the incarnation that would settle it. Found by the scan, not by review. The invariant names modules, not behaviours, and helper-delivered signals are invisible to it, so the document's table is the checklist.                                                                                                                                                                                                                                                                                                                                                                                                    |
