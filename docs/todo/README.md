...
|                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`superseded-routing-generation-has-no-owner.md`](./superseded-routing-generation-has-no-owner.md) | A schema change mints a new routing-status address and nothing reclaims the old one — eleven generations on one host. A time-based sweep was written and reverted: this build cannot parse the address it would delete, so whether it holds an obligation is unanswerable here. The quarantine surface fits; its 16-slot ceiling is the open question. |
