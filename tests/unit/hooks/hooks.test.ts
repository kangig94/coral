...
describe('codex.json', () => {
  ...
  it('omits the Claude-only hooks (hud-auto-update, subagent-start, subagent-track)', () => {
    const raw = readFileSync(CODEX_HOOKS_JSON_PATH, 'utf-8');
    for (const script of ['hud-auto-update.mjs', 'subagent-start.mjs', 'subagent-track.mjs']) {
