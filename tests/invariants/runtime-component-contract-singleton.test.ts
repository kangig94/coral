...
describe('runtime-component-contract-singleton invariant', () => {
  it('RuntimeComponent, RuntimeComponentRegistry, RuntimeComponentStatus types are exported only from src/coordinator/runtime-components/', () => {
    const canonical: Record<string, string> = {
      RuntimeComponent: 'src/coordinator/runtime-components/contract.ts',
      RuntimeComponentRegistry: 'src/coordinator/runtime-components/registry.ts',
      RuntimeComponentStatus: 'src/coordinator/runtime-components/contract.ts',
    };
