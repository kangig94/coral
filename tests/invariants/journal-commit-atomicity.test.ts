...
const KB_SHELL_PATH = 'src/coordinator/kb-child/services/shell.ts';
const KB_SOURCE_IMPORT_SERVICE_PATH = 'src/coordinator/kb-child/services/source-import.ts';
const KB_REINDEX_SERVICE_PATH = 'src/coordinator/kb-child/services/reindex.ts';
