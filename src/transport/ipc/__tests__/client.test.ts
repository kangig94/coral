...
import { decode, encode, type JsonRpcRequest, type JsonRpcResponse } from '../../json-rpc.js';
import { requestIpcMethod } from '../client.js';
...
describe('ipc client', () => {
  ...
  it('retries once on ECONNREFUSED before succeeding', async () => {
    ...
    const { requestIpcMethod: requestWithRetry } = await import('../client.js');
