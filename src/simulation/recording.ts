...
import { normalizeSpawnRecording, type SpawnRecording } from '../infra/process/spawn-recording.js';
...
export type { SpawnRecording } from '../infra/process/spawn-recording.js';
