...
import { applyTestCounterMigration, testCounterRegistry } from '../../store/__tests__/fixtures/test-counter-registry.js';
import { SimulationRuntime } from '../runtime.js';

const MODULE_DIR = dirname(fileURLToPath(import.meta.url));
const MIGRATIONS_DIR = join(MODULE_DIR, '../../store/migrations');
