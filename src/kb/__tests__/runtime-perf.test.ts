...
import type * as MetadataCommitModule from '../curate/metadata-commit.js';
import type * as PrinciplesModule from '../curate/principles.js';
import type * as GitSyncModule from '../curate/git-sync.js';
import type * as ReindexModule from '../ops/reindex.js';
...
async function loadPerfModules(): Promise<LoadedPerfModules> {
  ...
  const principles = await import('../curate/principles.js');
  const gitSync = await import('../curate/git-sync.js');
  const reindex = await import('../ops/reindex.js');
  return {
    runtime,
    metadataCommit,
    principles,
