...
/**
 * SessionStart hook — cleans up stale flag files (>24h) from .claude/coral/tmp/.
 * Handles both memo-reminded-{session} and kb-active-{session} prefixes.
...
const STALE_PREFIXES = ['memo-reminded-', 'kb-active-'];
