...
- Does it hide behind phrases like "may or may not," "depends," or similar immunity language?
- Is it predictive, or just a story that explains anything after the fact?
...
- Near-term testable: requires a specific next action; name the exact action, not "investigate further."
...
State the strongest version first: what is its best evidence, and what is its most charitable interpretation?
...
- **FALSIFIED**: a killing blow shows the hypothesis cannot stand.
- **WEAKENED**: damage is real but not decisive; state what evidence would finish falsification.
- **SURVIVED**: all vectors were attempted and none was decisive.
- Gate failures remain listed as **REJECTED** (from Step 1).
...
- Confirmation attack: striking disfavored hypotheses harder than favored ones.
- Premature elimination: calling FALSIFIED without decisive contradiction.
- Escape clause tolerance: allowing vague reformulations to evade disproof.
